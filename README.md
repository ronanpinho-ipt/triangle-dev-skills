...
![impact-report-builder running: intake, normalize to GRI/SASB/SDOH, source-trace, draft, and surface data gaps](.github/demo.gif)

The finished briefing it produces:
